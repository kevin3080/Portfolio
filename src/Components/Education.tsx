      ...
      <section className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-1 ">
        <section className="m-3">
          ...
          <ul>
            ...
            <li className="text-sm italic font-light">2022 - Present</li>
          </ul>
        </section>
        ...
        <section className="m-2">
          <h3 className="">Next.js: El framework de React para producción</h3>
          <ul>
            <li className="text-sm italic font-light">Udemy</li>
            <li className="text-sm italic font-light">2022 - Present</li>
          </ul>
        ...
        <section className="m-2">
          <h3 className="">Nest Desarrollo backend escalable con Node</h3>
          <ul>
            <li className="text-sm italic font-light">Udemy</li>
            <li className="text-sm italic font-light">2022 - Present</li>
          </ul>
        ...
        <section className="m-2">
          <h3 className="">
            Java University - Zero to Expert - More Complete +106 hrs.
          </h3>
          <ul>
            <li className="text-sm italic font-light">Udemy</li>
            <li className="text-sm italic font-light">2022 - Present</li>
