...
export const Abaut = () => {
  return (
    <section className="container mx-auto w-[90%] md:w-[80%] sm:w-[90%] lg:w-[65%]">
      ...
      <section className="mt-7 text-left flex flex-col ">
        <div>
          <p className="text-xl">
            <Translation translationKey="about.p1" />
          </p>
          <p className="text-xl">
            innovatible solutions. Learning and teamwork bring me satisfaction,
            and I always strive for
          </p>
          <p className="text-xl">excellence in my projects.</p>
        </div>
      </section>
      <section className=" flex flex-col items-center">
        <section className=" mt-4 w-[90%] md:w-[80%] sm:w-[90%] lg:w-[70%]">
          <h3 className="text-left font-bold text-2xl ">Tech Stack:</h3>
