export const Contact = () => {
  return (
    <section className="h-[100%] bg-[#071739] mt-20 flex gap-20 justify-center items-center text-[#EBEBEB]">
      ...
      <section className="border bg-[#05112A] border-[#05112A] rounded-3xl w-[30%] min-h-min mt-32 mb-44">
